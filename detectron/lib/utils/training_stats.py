...
class TrainingStats(object):
    ...
    def UpdateIterStats(self):
        ...
        self.smoothed_mb_qsize.AddValue(
            self.model.roi_data_loader._minibatch_queue.qsize() if self.model.roi_data_loader is not None else self.teacher_model.roi_data_loader._minibatch_queue.qsize()
        )
