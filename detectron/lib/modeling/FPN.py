...
def add_fpn(model, fpn_level_info):
    ...
    fpn_dim = int(cfg.FPN.DIM*cfg.RESNETS.CHANNEL_RATIO)
...
def fpn_level_info_ResNet50_conv5():
    return FpnLevelInfo(
        ...
        dims=(int(2048*cfg.RESNETS.CHANNEL_RATIO), int(1024*cfg.RESNETS.CHANNEL_RATIO), int(512*cfg.RESNETS.CHANNEL_RATIO), int(256*cfg.RESNETS.CHANNEL_RATIO)),
