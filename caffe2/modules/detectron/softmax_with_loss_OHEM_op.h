...
#ifndef SOFTMAX_WITH_LOSS_OHEM_OP_H_
#define SOFTMAX_WITH_LOSS_OHEM_OP_H_
...
class SoftmaxWithLossOHEMOp final : public Operator<Context> {
 public:
  SoftmaxWithLossOHEMOp(const OperatorDef& operator_def, Workspace* ws)
