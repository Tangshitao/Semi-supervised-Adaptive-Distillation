...
#ifndef SMOOTH_L1_LOSS_OHEM_OP_H_
#define SMOOTH_L1_LOSS_OHEM_OP_H_
...
class SmoothL1LossOHEMOp final : public Operator<Context> {
 public:
  SmoothL1LossOHEMOp(const OperatorDef& operator_def, Workspace* ws)
